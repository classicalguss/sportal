...
(function(t) {
    ...
    function f(t, e) {
        return t.height(e).addClass("fc-scroller"),
            t[0].scrollHeight - 1 > t[0].clientHeight ? !0 : (g(t),
                !1)
    }
    function g(t) {
    ...
    function A(n, i, r) {
        ...
        return e.isMoment(u) ? (a = e.apply(null, n),
            Y(u, a)) : C(u) || void 0 === u ? a = e.apply(null, n) : (s = !1,
            o = !1,
            d ? Pe.test(u) ? (u += "-01",
                n = [u],
                s = !0,
                o = !0) : (l = Ve.exec(u)) && (s = !l[5],
                o = !0) : t.isArray(u) && (o = !0),
            a = i || s ? e.utc.apply(e, n) : e.apply(null, n),
            s ? (a._ambigTime = !0,
                a._ambigZone = !0) : r && (o ? a._ambigZone = !0 : d && a.zone(u))),
            a._fullCalendar = !0,
            a
    }
    function N(t, n) {
    ...
    function W(t, e) {
        var n, i;
        return "string" == typeof e ? e : (n = e.token) ? Ae[n] ? Ae[n](t) : B(t, n) : e.maybe && (i = I(t, e.maybe),
            i.match(/[1-9]/)) ? i : ""
    }
    ...
    function X(t, e, n, i, r) {
        ...
        for (o = 0; n.length > o && (s = $(t, e, n[o]),
        s !== !1); o++)
            u += s;
        for (l = n.length - 1; l > o && (s = $(t, e, n[l]),
        s !== !1); l--)
            d = s + d;
        for (a = o; l >= a; a++)
            c += W(t, n[a]),
    ...
    function $(t, e, n) {
        var i, r;
        return "string" == typeof n ? n : (i = n.token) && (r = Ne[i.charAt(0)],
        r && t.isSame(e, r)) ? B(t, i) : !1
    }
    function U(t) {
    ...
    function ue(t) {
        ...
        for (e = 0; t.length > e; e++) {
            for (n = t[e],
                     i = 0; r.length > i && fe(n, r[i]).length; i++)
                ;
            n.level = i,
                (r[i] || (r[i] = [])).push(n)
        }
    ...
    function me(n, r) {
        ...
        function a() {
            ...
            re && n.prepend(re),
                c(te.defaultView),
            te.handleWindowResize && (ue = G(E, te.windowResizeDelay),
                t(window).resize(ue))
        }
        function u() {
            le && le.destroyView(),
        ...
        function h(e, n) {
            pe++,
            le && n && le.type !== n && (ie.deactivateButton(le.type),
                j(),
            ...
            !le && n && (le = f(n),
                ...
                ie.activateButton(n)),
            le && (0 > e ? de = le.computePrevDate(de) : e > 0 && (de = le.computeNextDate(de)),
            le.start && !e && de.isWithin(le.intervalStart, le.intervalEnd) || d() && (j(),
            le.start && le.destroyView(),
                le.setDate(de),
                le.renderView(),
                X(),
        ...
        function q(t, e) {
            return void 0 === e ? te[t] : (("height" == t || "contentHeight" == t || "aspectRatio" == t) && (te[t] = e,
                v(!0)),
                void 0)
        }
        function K(t, e) {
        ...
        var ee = x(s(te.lang));
        if (te.monthNames && (ee._months = te.monthNames),
        ...
        Q.defaultAllDayEventDuration = e.duration(te.defaultAllDayEventDuration),
            ...
            Q.moment = function() {
                var t;
                return "local" === te.timezone ? (t = De.moment.apply(null, arguments),
                t.hasTime() && t.local()) : t = "UTC" === te.timezone ? De.moment.utc.apply(null, arguments) : De.moment.parseZone.apply(null, arguments),
    ...
    function ye(n) {
        ...
        function o(e, i) {
            ...
            for (r = 0; l.length > r; r++) {
                if (s = l[r].call(O, e, B.clone(), Z.clone(), n.timezone, i),
                s === !0)
                    return;
                if ("object" == typeof s)
                    return o(s, i),
        ...
        function v(e) {
            return t.isFunction(e) ? t.grep(Q, e) : null != e ? (e += "",
                t.grep(Q, function(t) {
                    return t._id == e
                })) : Q
        }
        ...
        function C(t) {
            null == t.allDay && (t.allDay = !(t.start.hasTime() || t.end && t.end.hasTime())),
                ...
                t.end && t.end.stripTime()) : (t.start.hasTime() || (t.start = O.rezoneDate(t.start)),
        ...
        function z(e, n, i, r, s, o) {
            ...
            s && !s.valueOf() && (s = null),
                t.each(e, function(e, u) {
                    ...
                    r && (c.start.add(r),
                    c.end && c.end.add(r)),
                    s && (c.end || (c.end = O.getDefaultEventEnd(c.allDay, c.start)),
                        c.end.add(s)),
                    l && !c.allDay && (r || s) && (c.start.stripZone(),
            ...
            for (o = 0; Q.length > o; o++)
                ...
                (!i || i._id !== l._id) && Y(l, t)) {
                    ...
                    if ("function" == typeof n && !n(l, i))
                        return !1;
                    if (i) {
                        if (a = F(l.overlap, (l.source || {}).overlap),
                        a === !1)
                            return !1;
    ...
    t.fn.fullCalendar = function(e) {
        ...
        return this.each(function(r, s) {
            ...
            r || (i = o),
            "destroy" === e && l.removeData("fullCalendar")) : a || (a = new me(l,e),
    ...
    De.moment = function() {
        ...
        _e.isSame = function(t, e) {
            var n;
            return this._fullCalendar ? e ? (n = N([this, t], !0),
                Ge.isSame.call(n[0], n[1], e)) : (t = De.moment.parseZone(t),
            Ge.isSame.call(this, t) && Boolean(this._ambigTime) === Boolean(t._ambigTime) && Boolean(this._ambigZone) === Boolean(t._ambigZone)) : Ge.isSame.apply(this, arguments)
        }
        ,
        t.each(["isBefore", "isAfter"], function(t, e) {
            _e[e] = function(t, n) {
                var i;
                return this._fullCalendar ? (i = N([this, t]),
                    Ge[e].call(i[0], i[1], n)) : Ge[e].apply(this, arguments)
            }
        }),
    ...
    var Oe = K.extend({
        ...
        position: function() {
            ...
            r = o.top || 0,
                ...
                e += d.scrollTop(),
                n += d.scrollLeft(),
            o.viewportConstrain !== !1 && (r = Math.min(r, e + c.outerHeight() - u - this.margin),
        ...
        getCell: function(t, e) {
            ...
            if (this.inBounds(t, e)) {
                ...
                if (null !== l && null !== a)
                    return r = this.grid.getCell(l, a),
                        r.grid = this.grid,
                        r
            }
            return null
        ...
        startListening: function(e) {
            var n, i;
            this.isListening || (e && this.options.scroll && (n = p(t(e.target)),
        ...
        drag: function(t) {
            ...
            Q(e, this.cell) || (this.cell && this.cellOut(),
            e && this.cellOver(e)),
                this.dragScroll(t))
        },
        cellOver: function(t) {
            ...
            var n, i = this, r = this.view, s = t.el, o = t.event, l = new We(t.el,{
                ...
                cellOver: function(e, s) {
                    ...
                    n = i.computeEventDrop(u, e, o),
                        n ? (r.renderDrag(n, t) ? l.hide() : l.show(),
                        s && (n = null)) : (l.show(),
                            a())
                },
                cellOut: function() {
                ...
                if (s = h[r],
                    ...
                    for (a = 0; s.length > a; a++) {
                        for (u = s[a],
                                 ...
                                 u.leftCol != u.rightCol ? d.attr("colspan", u.rightCol - u.leftCol + 1) : v[r][o] = d; u.rightCol >= o; )
                            m[r][o] = d,
                                p[r][o] = u,
                                o++;
                        l.append(d)
        ...
        slatRowHtml: function() {
            for (var t, n, i, r = this.view, s = this.isRTL, o = "", l = 0 === this.slotDuration.asMinutes() % 15, a = e.duration(+this.minTime); this.maxTime > a; )
                t = this.start.clone().time(a),
                    n = t.minutes(),
                    i = '<td class="fc-axis fc-time ' + r.widgetContentClass + '" ' + r.axisStyleAttr() + "><span>" + z(t.format(this.axisFormat)) + "</span>" + "</td>",
                    o += "<tr>" + (s ? "" : i) + '<td class="' + r.widgetContentClass + '"/>' + (s ? i : "") + "</tr>",
            ...
            if (n.length) {
                for (n = this.renderFillSegEls(e, n),
                    ...
                    if (a = r[l],
                        u = t("<td/>").appendTo(o),
                        a.length)
                        for (d = t('<div class="fc-' + i + '-container"/>').appendTo(u),
    ...
    var qe = De.View = K.extend({
        ...
        opt: function(e) {
            ...
            return n = this.options[e],
                void 0 !== n ? n : (n = this.calendar.options[e],
        ...
        computeRange: function(t) {
            var n, i, r = e.duration(this.opt("duration") || this.constructor.duration || {
                days: 1
            }), s = b(r), o = t.clone().startOf(s), l = o.clone().add(r);
            return D("days", r) ? (o.stripTime(),
                l.stripTime()) : (o.hasTime() || (o = this.calendar.rezoneDate(o)),
        ...
        documentMousedown: function(e) {
            var n;
            this.isSelected && this.opt("unselectAuto") && v(e) && (n = this.opt("unselectCancel"),
    ...
    var Ke = {
        ...
        setHeight: function(t, e) {
            ...
            i && "number" != typeof i && this.dayGrid.limitRows(i),
            !e && f(this.scrollerEl, n) && (o(this.headRowEl, m(this.scrollerEl)),
                n = this.computeScrollerHeight(t),
    ...
    Ce.agenda = qe.extend({
        ...
        initialize: function() {
            this.timeGrid = new Ue(this),
                this.opt("allDaySlot") ? (this.dayGrid = new $e(this),
                    this.coordMap = new Ze([this.dayGrid.coordMap, this.timeGrid.coordMap])) : this.coordMap = this.timeGrid.coordMap
        },
        setRange: function(t) {
            qe.prototype.setRange.call(this, t),
        ...
        headIntroHtml: function() {
            ...
            '<th class="fc-axis fc-week-number ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + ">" + "<span>" + z(i) + "</span>" + "</th>") : '<th class="fc-axis ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + "></th>"
        },
        dayIntroHtml: function() {
        ...
        setHeight: function(t, e) {
            ...
            e || (i = this.computeScrollerHeight(t),
                f(this.scrollerEl, i) ? (o(this.noScrollRowEls, m(this.scrollerEl)),
                    i = this.computeScrollerHeight(t),
                    this.scrollerEl.height(i),
                    this.restoreScroll()) : (this.scrollerEl.height(i).css("overflow", "hidden"),
